...
export default async function DashboardLeadsPage() {
  ...
  const disabledReason = isLocalReadOnly
    ? "Modo local en solo lectura. Añade SUPABASE_SERVICE_ROLE_KEY para actualizar leads reales."
    : undefined;
  ...
  return (
    <div className="space-y-8">
      <DashboardPageHeader
        title="Leads"
        description="Registro de contactos recibidos desde el formulario público, estado comercial y trazabilidad del envío de emails."
      />
