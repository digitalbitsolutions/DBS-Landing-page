...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-sm whitespace-nowrap text-sm font-semibold tracking-wide transition-all duration-300 cursor-pointer disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8da4b3]/60",
  {
    variants: {
      variant: {
        default:
