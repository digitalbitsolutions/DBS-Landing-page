...
export default function LoginForm() {
  ...
  return (
    <Card className="mx-auto w-full max-w-md">
      <CardHeader>
        <CardTitle>Acceso al CMS</CardTitle>
        <CardDescription>
          Puedes usar Supabase Auth con email o, en local, las credenciales de admin configuradas en el entorno.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="text" placeholder="admin@digitalbitsolutions.com o yampi" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
